...
/***/ function(module, exports, __webpack_require__) {
	...
	const End = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var endGame = function () {
	  $('#score-box').html("<div class='score'>Score:<br>  " + localStorage.getItem('score') + "</div><div class='high-score'>High Score:<br> " + localStorage.getItem('highScore') + "</div><div class='mystery-info'>Mystery Word:<br> " + localStorage.getItem('mysteryWord') + "</div><a href='https://adam-rice.github.io/Lingo/lib/game.html'><button type=button id='play-again-button'>Play Again!</button></a>");
	};
