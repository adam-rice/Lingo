...
var guess = $('input').on('keypress',function(event){
  ...
  function newWordRow(){
    ...
    return "<tr class='letter-tile'><td class= "+colorArray[0]+">"+userWordArray[0]+"</td><td class="+colorArray[1]+">"+userWordArray[1]+"</td><td class="+colorArray[2]+">"+userWordArray[2]+"</td><td class="+colorArray[3]+">"+userWordArray[3]+"</td><td class="+colorArray[4]+">"+userWordArray[4]+"</td></tr>";
  }
  function prependRow(){
