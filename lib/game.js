...
function mysteryRow(){
  return "<tr class = 'header-tile'><th>"+mysteryWordArray[0]+"</th><th>"+mysteryWordArray[1]+"</th><th>"+mysteryWordArray[2]+"</th><th>"+mysteryWordArray[3]+"</th><th>"+mysteryWordArray[4]+"</th></tr>";
}
