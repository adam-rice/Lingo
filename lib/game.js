...
var guess = $('input').on('keypress',function(event){
  ...
  function newWordRow(){
    ...
    return "<tr class='letter-tile' id='zero'><td>"+userWordArray[0]+"</td><td id='one'>"+userWordArray[1]+"</td><td id='two'>"+userWordArray[2]+"</td><td id='three'>"+userWordArray[3]+"</td><td id='four'>"+userWordArray[4]+"</td></tr>";
  }
  function prependRow(){
